...
public class Item {
    ...
    public Item(String name, Float price, String description, String image, LocalDate updateOn) {
        this.name = name;
        this.price = price;
    ...
    public Item(Integer id, String name, Float price, String description, String image, LocalDate updateOn) {
        this.id = id;
        this.name = name;
        this.price = price;
        this.description = description;
    ...
    public void setUpdate_on(LocalDate updateOn) {
        this.updateOn = updateOn;
    }
